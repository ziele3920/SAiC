...
\begin{itemize}
 \item Znając prąd $I_{EQ} \approx \mathbf{I_{CQ} = 3.5mA}$ 
 \item można wyliczyć $U_{CEQ} = U_{R_C} - U_{RE} = I_{CQ}*R_C - I_{EQ}*R_E$ \newline
	$\mathbf{U_{CEQ}} = 3.5*10^{-3}*1486.7 - 3.5*10^{-3}*552.3 = \mathbf{3.3V}$
\end{itemize}
...
\begin{itemize}
  ...
  \item Punkt pracy tranzystora to $I_{CQ} = 3.5mA \quad U_{CEQ} = 3.3V$.
\end{itemize}
\end{figure}
